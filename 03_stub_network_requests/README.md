...
* Crete a new file __/cypress/hotel-viewer/cypress/integration/hotel-viewer-init.spec.js__
...
* Open the __fixtures folder__ and add __hotels.json__
...
* Now we can go back to our spec, __cypress/integration/hotel-viewer-init.spec.js__
